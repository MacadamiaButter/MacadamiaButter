```console
$ whoami
building local-first tools: private by architecture, supervised by design

$ ls ~/projects
lfl-terminal/         a terminal for your browser. deterministic commands,
                      plus a local LLM that proposes single actions you
...
supervised-ops-demo/  a worked example of supervised AI operations for a
                      ...
                      counts as sent. a demo to watch, not a product.

Journal-Lens/         analyze your private journal with a local LLM.
                      your words never leave your machine.

local-claude-proxy/   point Anthropic-style tooling at a fully local model.
